...
Outputs
-------
data/outputs/traversal_results_depth_pareto_grid.json
data/outputs/pub_figures/fig8b_depth_pareto_heatmap.png
data/outputs/pub_figures/fig8c_efficiency_frontier.png
"""
