%% litdiscover_ipm.tex — Information Processing & Management submission (elsarticle)
%% Compile: pdflatex litdiscover_ipm && bibtex litdiscover_ipm && pdflatex litdiscover_ipm && pdflatex litdiscover_ipm
...
\author{David Goh}
\ead{daveed@cs.toronto.edu}
\affiliation{organization={Department of Computer Science, University of Toronto},
             city={Toronto},
             country={Canada}}
...
\textbf{David Goh:} Conceptualization, Methodology, Software, Validation, Formal analysis,
