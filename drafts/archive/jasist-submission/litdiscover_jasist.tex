%% litdiscover_jasist.tex — JASIST submission (plain article, single author)
%% Compile: pdflatex litdiscover_jasist && bibtex litdiscover_jasist && pdflatex litdiscover_jasist && pdflatex litdiscover_jasist
...
%% ── Figure path (relative from jasist-submission/ → pub_figures/) ───────────
...
\noindent\textbf{Keywords:} literature discovery, citation graph traversal, systematic review, snowballing, bibliographic retrieval
