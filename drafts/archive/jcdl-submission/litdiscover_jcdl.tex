%% litdiscover_jcdl.tex — JCDL 2026 anonymous submission (ACM sigconf)
%% Compile: pdflatex litdiscover_jcdl && bibtex litdiscover_jcdl && pdflatex litdiscover_jcdl && pdflatex litdiscover_jcdl
%%
%% CAMERA-READY CHECKLIST:
%%   1. Remove 'anonymous,review' from \documentclass options
%%   2. Uncomment the real \author / \affiliation / \email blocks below
%%   3. Uncomment \acmConference, \acmYear, \acmDOI
...
\usepackage{tabularx}
\usepackage{amsmath}
% \usepackage{soul}     % \hl{} annotation — not used in submission body
% \usepackage{mdframed} % not used in submission body
...
%% ── Conference block ─────────────────────────────────────────────────────────
\acmConference[JCDL '26]{ACM/IEEE Joint Conference on Digital Libraries}{2026}{Denton, TX, USA}
\acmYear{2026}
...
%% ── Figure path (relative from jcdl-submission/ → pub_figures/) ─────────────
...
%% Authors are suppressed by the [anonymous] class option.
